    ...
    <header id="header">
        ...
        <select class="custom-select custom-select-lg" id="gender2" name='filtro'>
          ...
          <option value="bebidas">Bebidas</option>
            ...
            <button type="submit" class="btn btn-success btn btn-block">Pesquisar</button>
        </div>
        </form>
        </div>
                </div>
                ...
                <?php foreach($pratos as $prato): ?>
                     <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <?php
                 //Se nome da imagem for igual a nulo, vai mostrar uma imagem padrão, senão, mostra imagem que foi upada
                            ...
                            <div class="card-body">                               
                                ...
                                <?php 
                                    if($prato['restricao_alimentar']=='Sim'){
                                        ...
                                        echo '<p class="card-text">Não possui opção sem glúten</p>';
                                    }
                                ?>
                               </div>
                            </div>
